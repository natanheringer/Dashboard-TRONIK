...
def resumo_operacional(db: Session, parceiro_id: int | None = None) -> dict[str, Any]:
    """
...
def validar_dados_coletor(dados: dict, criar: bool = True, db: Session | None = None) -> list[str]:
    """
...
def processar_ultima_coleta(ultima_coleta_str: str | None) -> datetime:
    """
