...
from banco_dados.services.coletor_service import (
    validar_dados_lixeira,
    processar_ultima_coleta
)
from banco_dados.modelos import Coleta, Coletor, Parceiro, TipoMaterial
...
class TestLixeiraServiceRobustez:
    ...
    def test_processar_ultima_coleta_none(self):
        ...
        from banco_dados.services.coletor_service import processar_ultima_coleta
...
class TestValidacaoEntradaRobustez:
    ...
    def test_validar_tipo_com_none(self):
        ...
        from banco_dados.utils.erros import validar_tipo, ErroValidacao
    ...
    def test_validar_range_com_none(self):
        ...
        from banco_dados.utils.erros import validar_range, ErroValidacao
